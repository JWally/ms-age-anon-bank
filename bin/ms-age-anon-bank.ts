...
// Personal stacks
// : add your details
// : and run `cdk bootstrap ms-age-anon-bank-demo-dev-XX (just do 1x / region)
// : next do `cdk deploy ms-age-anon-bank-demo-dev-XX`
// /////////////////////////////////
new AppStack(app, "ms-age-anon-bank-dev-jw", {
  // the custom props that your TheStack constructor requires
  env: { account: "263318538229", region: "us-east-1" },
  environment: "dev-jw",
  stackName: "ms-age-anon-bank-dev-jw",
  rootDomain: ROOT_DOMAIN,
  stage: "dev-jw",
  region: "us-east-1",
